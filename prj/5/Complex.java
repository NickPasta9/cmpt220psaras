class Complex extends Number implements Comparable<Complex>, Cloneable {
    ...
    public Complex divide(Complex o) {
        ...
        double divideA = (a * o.getRealPart() + b * o.getImaginaryPart())
                / (o.getRealPart() * o.getRealPart() + o.getImaginaryPart() * o.getImaginaryPart());
        double divideB = (b * o.getRealPart() - a * o.getImaginaryPart())
                / (o.getRealPart() * o.getRealPart() + o.getImaginaryPart() * o.getImaginaryPart());
